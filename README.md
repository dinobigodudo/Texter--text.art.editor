...
- ➕ Create: Create new text art easily* (the creation feature is a bit buggy; I'm currently working on a fix).  
...
- 💾 Persistence: All artworks are automatically saved to JSON* (I'm not sure if persistence will work correctly after deployment).  
